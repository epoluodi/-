...
- (void)viewDidLoad {
    [super viewDidLoad];
    rootview = (mainViewController*)[self tabBarController];
    ...
    if (indexPath.section ==0)
    {
        switch (indexPath.row) {
            case 0:
                ...
                if (rootview.islogin == NO)
                {
                    self.tabBarController.selectedIndex=0;
                    view =[self.tabBarController.viewControllers objectAtIndex:0];
