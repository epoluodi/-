...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //设置动画帧
        imageView.animationImages=[NSArray arrayWithObjects: [UIImage imageNamed:@"0"],
        ...
        Infolabel = [[UILabel alloc]initWithFrame:CGRectMake(0, frame.size.height-20, frame.size.width+20, 20)];
