...
- (void)viewDidLoad {
    ...
    NSArray *coverImageNames = @[@"1_1.png", @"2_2.png"];
    NSArray *backgroundImageNames = @[@"1.jpg", @"2.jpg"];
     [self initSelfWithCoverNames:coverImageNames backgroundImageNames:backgroundImageNames];
...
//    appdelegate.Mode = TabBAR;
    if (appdelegate.Mode ==TabBAR){
        [self performSegueWithIdentifier:@"showtab" sender:self];
            }
    else
    {
//                UIStoryboard *story;
//        FirstViewController *webview;
//        story = [UIStoryboard storyboardWithName:@"Main" bundle:[NSBundle mainBundle]];
//                        //
//    webview = [story instantiateViewControllerWithIdentifier:@"webview"];
//        [self presentViewController:webview animated:YES completion:nil];
        
        JVFloatingDrawer *drawerview = [[JVFloatingDrawer alloc] init];
        appdelegate.drawerview =drawerview;
        [drawerview showView:self];
    }
