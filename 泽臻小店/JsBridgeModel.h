...
/*
 * 微信支付
 * params传入APPID和APPSecret,需要自己申请的wx的appid给有赞，我们会回复您相对应的APPID和APPSecret
 */
- (NSDictionary *) WXPayURl:(NSURL *) url  params:(NSDictionary *)params block:(RequestReturnDetail) block;
